...
// execTx runs the provided function in a transaction.
...
// It creates a transfer record, and account entries, and update acocunts balance within a single database transaction
